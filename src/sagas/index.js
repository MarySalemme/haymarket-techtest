...
// export function watchVoteFetch(action: )
...
/**
 * Root saga containing all sagas.
 * Watches all {APPLY_VOTE} actions starts {watchVoteFetch} saga.
 *
 * @return {Generator} - watcher for FETCH_PROPS action.
 */
// export function* watchVoteRequests(): Generator <*, *, *>{
//   yield takeEvery(Actions.APPLY_VOTE, watchVoteFetch);
// }
